...
public class API_Key_Eingabe {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void aPI_Key_Eingabe() {
                ...
                allOf(withId(android.R.id.edit),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                1)));
        appCompatEditText4.perform(scrollTo(), replaceText("4c3d3172f2ca79d39d14dc98594b691c"), closeSoftKeyboard());
